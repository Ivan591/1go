...
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
    <title><?php echo ($ten_webtitle); ?></title>
    <meta name="description" content="<?php echo ($ten_description); ?>" />
    <meta name="keywords" content="<?php echo ($ten_keywords); ?>" />
...
<div class="top-back">
	...
	<div class="top-backs">
  	...
  	<div class="container" id="shoplist" url="<?php echo U('ten/index',array('ten'=>I('ten')));?>">
  		<!-- 产品列表开始 -->
