  	...
  	<div class="container">
  		<div class="porduct-block">
  			...
  			<div class="product-show">
  				<div class="preview">
  					<?php if(!empty($ten_name)): ?><div class="float-title ten"><?php echo ($ten_name); ?></div><?php endif; ?>
  			...
  			<div class="product-naving">
				...
				<?php if(($ten_restrictions_num-$no_count <= 0) and ($ten_restrictions > 0)): ?><div id="divEmpty" class="No_shopping product">
			            <b></b>
				...
				<div class="ro-goods reco-ing">
					...
					<div class="ro-goods-inputs">
						...
						<input type="type" value="<?php echo ($ten_unit); ?>" price="<?php echo ($price); ?>" unit="<?php echo ($ten_unit); ?>" surplus="<?php echo ($surplus); ?>" limit="<?php echo ($ten_restrictions_num-$no_count); ?>" name="number">
					...
					<?php if(empty($ten_restrictions)): ?><b class="renci_sz" val="30">30</b>
					<b class="renci_sz" val="50">50</b>
					<b class="renci_sz" val="100">100</b>
					<b class="renci_sz" val="<?php echo ($surplus); ?>">包尾</b><?php endif; ?>
					人次
					<div class="win_prob" style="display:none;"><span class="win_txt">获得几率1.96%<i></i></span></div>
					<?php if(!empty($ten_restrictions)): ?><div class="increase">最大参与<?php echo ($ten_restrictions_num-count($user_no)); ?>人次！</div><?php endif; ?>
				</div>
