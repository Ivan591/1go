...
<html>
    <head>
        ...
        <link href="/yyyg/Public/Static/bootstrap/css/bootstrap.min.css" rel="stylesheet">
        <link href="/yyyg/Public/Install/css/install.css" rel="stylesheet">
        <script src="/yyyg/Public/Static/jquery.js"></script>
        <script src="/yyyg/Public/Static/bootstrap/js/bootstrap.min.js"></script>
    </head>
    <body>
        <div class="navbar navbar-default navbar-static-top">
        	<div class="navbar-header">
				...
				<a href="http://1.hongxunkeji.com" class="nav-logo"><img src="/yyyg/Public/Install/images/logo.png" alt="lfdycms"></a>
			</div>
 ...
 defined('SAE_MYSQL_HOST_M') or define('SAE_MYSQL_HOST_M', '127.0.0.1'); defined('SAE_MYSQL_HOST_M') or define('SAE_MYSQL_PORT', '3306'); defined('SAE_MYSQL_DB') or define('SAE_MYSQL_DB', 'hxoneshop'); defined('SAE_MYSQL_USER') or define('SAE_MYSQL_USER', 'root'); ?>
    <h1>创建数据库</h1>
    <form action="/yyyg/install.php?s=/install/step2" method="post" target="_self" class="form-horizontal">
